...
const Trade = ({ setShow }) => {
    ...
    return (
        <>
            {true && <div class={`flex top-10 p-4 mb-4 text-sm ${transactionData.txnStatus ? 'text-green-800 rounded-lg bg-green-50 w-1/2 fixed left-[25%]' : 'text-red-800 rounded-lg bg-red-50 w-1/3 fixed left-[33%] '} dark:bg-gray-800 dark:text-blue-400 `} role="alert">
